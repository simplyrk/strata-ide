...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Strata".into(),
            items: vec![
                MenuItem::action("About Strata", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Strata", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Strata", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Strata Repository", feedback::OpenZedRepo),
                MenuItem::action(
                    "Strata Twitter",
                    super::OpenBrowser {
