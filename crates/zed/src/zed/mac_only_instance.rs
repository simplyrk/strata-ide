...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Strata Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Strata Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Strata Editor Preview Instance Running",
        ReleaseChannel::Stable => "Strata Editor Stable Instance Running",
    }
}
